...
Neither child has a \texttt{.cgs} of its own, but no \texttt{nested\_config}
override is written for that: the default \texttt{"auto"} already resolves
a repository with zero nested \texttt{*.cgs} matches as a normal leaf.

...
\begin{lstlisting}[language=bash]
$ pixi run cgitsync validate install.cgs
$ pixi run cgitsync view-tree install.cgs
\end{lstlisting}
...
\begin{lstlisting}[language=bash]
$ pixi run cgitsync initialise install.cgs --output-path "$CGSPATH"
\end{lstlisting}
...
\begin{lstlisting}[language=bash]
$ pixi run cgitsync clean-init install.cgs
\end{lstlisting}
...
\begin{lstlisting}[language=bash]
$ pixi run cgitsync purge install.cgs
\end{lstlisting}
...
Pass \texttt{--gts <snapshot.gts>} when you want to point a command at an

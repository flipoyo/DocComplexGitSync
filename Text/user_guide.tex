...
\texttt{pull-force}, \texttt{checkout}, \texttt{branch}, \texttt{add},
\texttt{rm}, \texttt{commit}, \texttt{push}, \texttt{merge},
\texttt{tag} and \texttt{freeze}. It narrows the command to the writable
...
never written to, with or without it.

...
$ pixi run cgitsync memory show <state> [--search-dir DIR]
\end{lstlisting}
...
\begin{itemize}
  ...
  \item \texttt{show} --- one State and every entry naming it. The
        argument is the State's content hash or any unambiguous prefix of
        it; nobody retypes sixty-four characters.
\end{itemize}

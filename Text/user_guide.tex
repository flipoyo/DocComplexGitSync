...
the same way a State or an Environment record is. There is no repository
mounted at this path yet (that is future work), so today's record stays
local to the machine that wrote it until that lands.

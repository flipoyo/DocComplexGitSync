...
Full narrative in
\texttt{docs/tutorials/03\_configuration\_discovery\_modes.md}.
...
The draft reconstructs 3a's hand-corrected file almost field-for-field: the
...
the filesystem rather than assuming it, so it cannot omit it the way 3a's
...
repositories are in \texttt{docs/tutorials/03\_configuration\_discovery\_modes.md}
\S4 --- this level is the condensed command sequence, not a restatement of

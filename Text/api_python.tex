...
\textbf{There is no repository mounted at \texttt{.self-history} yet.} The
record above stays in an ordinary, gitignored pending directory until the
nested-repository fold/push pipeline the AgentReport ticket designs (its
WP2/WP2b) lands; \texttt{memory\_reboot} and \texttt{memory\_clone} do not
yet know it exists.

...
No command writes the per-entry format yet, so most workspaces answer
\texttt{NO\_HISTORY} or \texttt{LEGACY} today. Migrating
\texttt{SyncLedger}'s own writes is the next milestone of the memory work.  \texttt{Finding} enumerates
